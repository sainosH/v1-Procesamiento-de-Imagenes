...
begin
  ...
  begin
    ...
    for i := 1 to 255 do
     //imgHisto.Canvas.LineTo(i SHL 1, Hal-round(fac*HH[0,i]));
  ...
  begin
    ...
    for i := 1 to 255 do
      //imgHisto.Canvas.LineTo(i SHL 1, Hal-round(fac*HH[1,i]));
  ...
  begin
    ...
    for i := 1 to 255 do
      //imgHisto.Canvas.LineTo(i SHL 1, Hal-round(fac*HH[2,i]));
  ...
  begin
    ...
    for i := 1 to 255 do
     // imgHisto.Canvas.LineTo(i SHL 1, Hal-round(fac*HH[3,i]));
